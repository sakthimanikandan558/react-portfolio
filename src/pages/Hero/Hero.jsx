...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    name: 'Sakthi Manikandan A',
    title: 'Full-Stack Developer | React & Laravel Specialist',
    location: 'Sivakasi, Tamil Nadu, India',
    skills: [
        'React.js', 'React Native', 'Laravel', 'PHP',
        'Redux', 'PostgreSQL', 'Tailwind CSS', 'Filament',
        'RESTful APIs', 'N8N', 'Superset', 'Git'
    ],
    ...
    quickLearner: true,
    problemSolver: true,
    currentRole: 'Software Developer @ Pranion Technology',
    hireable: function() {
        return (
            this.hardWorker &&
            this.problemSolver &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full-Stack Developer specializing in React, React Native, and Laravel 🚀 | Building scalable applications with modern technologies 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="/resume.pdf"
                  download="Sakthi_Manikandan_Resume.pdf"
