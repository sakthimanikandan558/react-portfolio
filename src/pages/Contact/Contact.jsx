...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "YOUR_WEB3FORMS_ACCESS_KEY"); // Replace with your Web3Forms access key from https://web3forms.com/
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">sakthimanikandan42@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+91 9025712828</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="group flex items-center gap-3 bg-gradient-to-r from-blue-600/10 to-blue-500/10 hover:from-blue-600/20 hover:to-blue-500/20 border border-blue-500/30 rounded-lg px-4 py-3 transition-all duration-300 hover:scale-105"
                  >
                  ...
                  <a
                    href="https://github.com/sakthimanikandan558"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center gap-3 bg-gradient-to-r from-gray-600/10 to-gray-500/10 hover:from-gray-600/20 hover:to-gray-500/20 border border-gray-500/30 rounded-lg px-4 py-3 transition-all duration-300 hover:scale-105"
                  >
                    <FaGithub className="w-6 h-6 text-gray-400 group-hover:text-gray-300 transition-colors" />
                    <div>
                      <p className="text-xs text-gray-400">GitHub</p>
                      <p className="text-sm font-medium text-white">sakthimanikandan558</p>
                    </div>
                  </a>
                </div>
              </div>
